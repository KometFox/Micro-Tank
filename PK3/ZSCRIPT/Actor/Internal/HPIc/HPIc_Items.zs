...
//AUXILLARY ITEMS
//------------------------------------------------------------------------------
	Items[1][0][0].cost_credit = 5;
	Items[1][0][0].cost_metal = 5;
	...
	Items[1][1][0].cost_credit = 25;
	Items[1][1][0].cost_metal = 20;
...
//AUXILLARY ITEMS
//------------------------------------------------------------------------------
	Items[2][0][0].cost_credit = 150;
	Items[2][0][0].cost_metal = 0;
	...
	Items[2][0][1].cost_credit = 250;
	Items[2][0][1].cost_metal = 25;
	...
	Items[2][0][2].cost_credit = 370;
	Items[2][0][2].cost_metal = 50;
	...
	Items[2][0][3].cost_credit = 250;
	Items[2][0][3].cost_metal = 25;
	...
	Items[2][0][4].cost_credit = 370;
	Items[2][0][4].cost_metal = 50;
	...
	Items[2][0][5].cost_credit = 250;
	Items[2][0][5].cost_metal = 25;
	...
	Items[2][0][6].cost_credit = 370;
	Items[2][0][6].cost_metal = 50;
	...
	Items[2][1][0].cost_credit = 250;
	Items[2][1][0].cost_metal = 25;
	...
	Items[2][1][1].cost_credit = 370;
	Items[2][1][1].cost_metal = 50;
	...
	Items[2][1][2].cost_credit = 200;
	Items[2][1][2].cost_metal = 0;
	...
	Items[2][1][3].cost_credit = 800;
	Items[2][1][3].cost_metal = 30;
